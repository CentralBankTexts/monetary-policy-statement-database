...
The MPSD is a **semi-public resource**. This is a beta (early access) release of the MPSD. The full version will be released upon journal publication. To access the dataset and accompanying codebase, please follow these steps:
...
4. *Access is granted for academic research purposes only.*
...
If you use this database or the associated methodology in your research, please cite the following:

> Baird, C., Benchimol, J., Vyshnevska, V., Sohn, W., & Vyshnevskyi, I. (2026). *The monetary policy statement database.* IFC Bulletin, 67.
...
### License
Data are licensed under CC BY 4.0. Code is licensed under the MIT License.
